...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) -> Int {
        if(userChoice.elementsEqual(stories[storyNumber].choice1)){
            self.storyNumber = stories[storyNumber].choice1Destination
            print("Brain \(self.storyNumber)")
        } else {
    ...
    func storyTitle(_ position: Int) -> String {
        return stories[position].title
    }
    
    func storyChoiceOne(_ position: Int) -> String {
        return stories[position].choice1
    }
    
    func storyChoiceTwo(_ position: Int) -> String {
